`anti-ad` is a **Firefox** add-on that removes "Ad blocking detected" messages from HTML pages. Some website overlay their message in a way that after removing them the original content can be viewed.
